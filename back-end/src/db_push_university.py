...
for item in data[1]:
    ...
    new_uni = University(univ_name = item['latest.school.name'], alias = item['latest.school.alias'], rank = 0, 
    ...
    num_graduate = item['latest.student.enrollment.grad_12_month'], is_private = ownership, mascot_name = "NaN", 
