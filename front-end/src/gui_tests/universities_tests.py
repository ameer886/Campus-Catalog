...
class Test(unittest.TestCase):
    ...
    def testSort(self):
        ...
        self.driver.find_element(
            By.XPATH, "/html/body/div/div[2]/div/div[2]/form/div[2]/div/input"
        ).click()
        self.driver.implicitly_wait(10)
        university = self.driver.find_element(
            By.XPATH, "/html/body/div/div[2]/div/div[1]/div[1]/div/a[1]/div/h2"
        )
    ...
    def testFilter(self):
        ...
        self.driver.implicitly_wait(10)
        self.driver.find_element(
            By.XPATH, "/html/body/div/div[2]/div/div[2]/div/button"
        ).click()
        city_filter = self.driver.find_element(
            By.XPATH, "/html/body/div[2]/div[3]/div[1]/form/div/div/input"
        )
        ...
        university = self.driver.find_element(
            By.XPATH, "/html/body/div[1]/div[2]/div/div[1]/div[1]/div/a/div/h2"
        )
    ...
    def testUniversityInstance(self):
        ...
        address = self.driver.find_element(
            By.CLASS_NAME, "University_Location__2j2b-"
        ).text
